...
class LLMClientInterface(ABC):
    ...
    def generate_chat_completion(
        ...
        Args:
            ...
            options: 可选的字典，包含额外的LLM参数，如temperature, top_p等。 # 已修改: 添加描述
        Returns:
    ...
    # 已修改: 添加 options 参数并传递给 generate_chat_completion
    def chat_completion(self, messages: List[Dict[str, str]], model: str = None,
        ...
        Args:
            ...
            options: 可选的字典，包含额外的LLM参数，如temperature, top_p等。
        Returns:
